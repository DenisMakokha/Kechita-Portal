...
import atsRouter from './modules/recruitment/ats-routes.js';
import atsCommunicationRouter from './modules/recruitment/ats-communication-routes.js';
import atsScreeningRouter from './modules/recruitment/ats-screening-routes.js';
...
app.use('/ats-comm', atsCommunicationRouter);
app.use('/ats-screen', atsScreeningRouter);
